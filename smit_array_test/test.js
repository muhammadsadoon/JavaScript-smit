...
//program no 19:
console.log("******************************************************************");
console.log("program no 19:");
var arr_19 = ["s", "a", "d", "o", "o", "n"];
console.log(arr_19);
var reverse = arr_19.reverse();
console.log(reverse);

//program no 20:
console.log("******************************************************************");
console.log("program no :20");
var arr_20 = ["s", "a", "d", "o", "o", "n", "a", "l", "i", "o"];
console.log("last index is:", arr_20.lastIndexOf("o"));

//program no 21:
console.log("******************************************************************");
console.log("program no :21");
var url = "https://jsonplaceholder.typicode.com/users";
var u_url = prompt("enter the urls input");
if (url.indexOf(u_url) !== -1) {
    console.log("/" + u_url);
} else {
    console.log("the user urls is not in field");
}

//program no 22:
console.log("******************************************************************");
console.log("program no :22");
var x = [
    ['Jack', 24],
    ['Sara', 23],
    ['Peter', 24]
...
if(x[0][1] == 24){
    console.log("the",x[0][0],"have 24 number")
}
if(x[1][1] == 24){
    console.log("the",x[1][0],"have 24 number")
}
if(x[2][1] == 24){
    console.log("the",x[2][0],"have 24 number")
}
